...
import com.exataid.apontamentoplantio.telas.adapters.ConfigWSAdapter;
...
public class ConfigWebServiceActivity extends AppCompatActivity {
    ...
    void carregarDados() throws ExecutionException, InterruptedException {
        ListaConfigs = APDatabase.getInstance(this).getConfigWSDAO().buscarTodas().get();
    }
        ...
        try {
            ...
            if (conteudo != null) {
                if (!conteudo.equals("")) {
                    ...
                    APDatabase.getInstance(this).getConfigWSDAO().limpar();
                    ListaConfigs.clear();
                    ...
                    APDatabase.getInstance(this).getConfigWSDAO().inserir(wsc);
