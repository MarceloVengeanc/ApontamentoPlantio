...
public class MenuPrincipalApPlantioActivity extends AppCompatActivity {
    ...
    private void setaBotoes() {
        btnApontamento.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(MenuPrincipalApPlantioActivity.this, ApontamentoPlantioActivity.class);
                startActivity(i);
            }
        });
    ...
    public void criaBanco() {
        ...
        try {
            APDatabase.getInstance(this).getFazendasDAO().inserir(fazendas).get();
            APDatabase.getInstance(this).getTalhaoDAO().inserir(talhoes).get();
            APDatabase.getInstance(this).getFuncionarioDAO().inserir(funcionarios).get();
